...
.DESCRIPTION
    This script creates:
      1. A source volume in East US 2 (eu2tstanf01)
      2. A DR (DataProtection) volume in Central US (custstanf01) linked to the source
...
param (
    ...
    [Parameter(Mandatory = $false)]
    [string]$SourceSubnetId = "/subscriptions/c303bd32-eddf-42ca-9946-d679e0b1e1f3/resourceGroups/eastus2-network-rg/providers/Microsoft.Network/virtualNetworks/eastus2-vnet/subnets/anf.subnet",
    ...
    [Parameter(Mandatory = $false)]
    [string]$DRSubnetId = "/subscriptions/c303bd32-eddf-42ca-9946-d679e0b1e1f3/resourceGroups/centralus-network-rg/providers/Microsoft.Network/virtualNetworks/centralus-vnet/subnets/anf.subnet",
...
$exportPolicyRules = @(
    @{
        ...
        Nfsv3            = $false
        Nfsv41           = $true
        AllowedClients   = "10.15.32.0/20,10.15.48.0/20,10.15.16.0/20"
    ...
    @{
        ...
        Nfsv3            = $false
        Nfsv41           = $true
        AllowedClients   = "10.20.33.22,10.20.33.23"
        Kerberos5ReadOnly  = $false
        Kerberos5ReadWrite = $false
        Kerberos5iReadOnly  = $false
        Kerberos5iReadWrite = $false
