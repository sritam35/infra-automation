...
.DESCRIPTION
    ...
    Environments:
      PRODUCTION
        Source (Primary)  : East US 2  | Account: eu2prdanf01  | RG: eastus2-eu2prdanf01-rg  | Pool: quant_standard
        DR (Secondary)    : Central US | Account: cusprdanf01  | RG: centralus-cusprdanf01-rg | Pool: quant_standard
      TEST
        Source (Primary)  : East US 2  | Account: eu2tstanf01  | RG: eastus2-eu2tstanf01-rg  | Pool: test_pool
        DR (Secondary)    : Central US | Account: custstanf01  | RG: centralus-custstanf01-rg | Pool: test
      Subscription      : c303bd32-eddf-42ca-9946-d679e0b1e1f3
...
if ($Help) {
    ...
    Write-Output '    Source : eu2prdanf01  (eastus2-eu2prdanf01-rg)  Pool: quant_standard'
    Write-Output '    DR     : cusprdanf01  (centralus-cusprdanf01-rg) Pool: quant_standard'
    Write-Output '  Test'
    Write-Output '    Source : eu2tstanf01  (eastus2-eu2tstanf01-rg)  Pool: test_pool'
    Write-Output '    DR     : custstanf01  (centralus-custstanf01-rg) Pool: test'
    Write-Output ''
...
$envDefaults = if ($Environment -eq "Test") {
    @{
        SourceResourceGroup = "eastus2-eu2tstanf01-rg"
        SourceAccountName   = "eu2tstanf01"
        DRResourceGroup     = "centralus-custstanf01-rg"
        DRAccountName       = "custstanf01"
        DRPoolName          = "test"
    }
} else {
    @{
        SourceResourceGroup = "eastus2-eu2prdanf01-rg"
        SourceAccountName   = "eu2prdanf01"
        DRResourceGroup     = "centralus-cusprdanf01-rg"
        DRAccountName       = "cusprdanf01"
