...
| Build Artifacts | `\\fileserver\Build\DevOps\[Pipeline]\[BuildNumber]` |
...
- task: PublishBuildArtifacts@1
  inputs:
    PathtoPublish: '\\fileserver\Build\DevOps\$(Build.DefinitionName)\$(Build.BuildNumber)'
...
# Expected output:
# -rwx------ 1 svc-netapp corp  5196 Feb 16 09:54 check_token_health.py
# -rwx------ 1 svc-netapp corp  3326 Feb 16 09:54 commvault_get_api.py
# -rwx------ 1 svc-netapp corp 56084 Feb 16 09:54 commvault_post_api.py
# -rwx------ 1 svc-netapp corp  ...  Feb 16 09:54 dynamic_datalakebkp_exclusions.py
# -rwx------ 1 svc-netapp corp  ...  Feb 16 09:54 renew_token.py
# -rwx------ 1 svc-netapp corp  ...  Feb 16 09:54 token_manager.py
```
...
-rwx------ 1 1631689629 corp 5196 Feb 13 11:51 check_token_health.py
```
...
-rwx------ 1 svc-netapp corp 56084 Feb 16 09:54 commvault_post_api.py
```
✅ Owner: `svc-netapp` | ✅ Group: `corp` | ✅ Permissions: `700`
...
| Artifact not published | Check build logs for PublishBuildArtifacts errors; verify `\\fileserver\Build\DevOps\` is accessible from SharedBuild agent |
