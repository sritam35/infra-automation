...
```bash
CLUSTERS=("cluster-01" "cluster-02" "cluster-03" "cluster-04" "cluster-05" "cluster-06")
OUTPUT_DIR="/mnt/automation/nfs/storageautomation/outputs"
DATE=$(date +%Y%m%d)
...
# Send via sendmail
{
    echo "To: storage-admins@corp.example.com"
    echo "From: automation@corp.example.com"
...
column -t -s',' "$OUTPUT"
sudo cp "$OUTPUT" "/mnt/automation/nfs/storageautomation/outputs/"
```
