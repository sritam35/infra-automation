...
ONTAP_CLUSTERS_FILE = os.environ.get("NETAPP_CLUSTERS_FILE",
                          "/mnt/automation/nfs/backupautomation/monitoring/netapp_clusters.conf")
...
ANF_ACCOUNTS = [
    {
        "account_name":   "anf-dr-account",
        "resource_group": "centralus-anf-dr-account-rg",
        "region":         "centralus",
        "label":          "CUS",
    },
    {
        "account_name":   "anf-primary-account",
        "resource_group": "eastus2-anf-primary-account-rg",
        "region":         "eastus2",
        "label":          "EU2",
    },
]
...
DFS_MAPPING_COLS = [
    "dfs_path",     # DFS namespace path  e.g. \\corp.example.com\BosProd\Current
