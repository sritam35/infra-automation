...
def main(
    ...
    #   - All ANF volumes from eu2prdanf01 (EU2 ANF — no Commvault backup taken)
    ...
    def _backup_override(rec: dict, cv_result: bool) -> str:
        ...
        if plat == "ANF" and clust == "eu2prdanf01":
            return "NA"
    ...
    print(f"[MAIN] Not applicable   : {not_applic}  (eu2prdanf01 + tst/sqlbkp/root/esx/cvault/test volumes)")
